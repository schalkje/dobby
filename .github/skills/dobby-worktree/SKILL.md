...
compatibility: git 2.5+ (worktree support)
metadata:
  author: dobby
  version: "1.0"
  scenario: github
...
<!-- Generated by scripts/build-skills.py from skills/_common/dobby-worktree/SKILL.md — do not edit this copy; edit the source and regenerate. -->
