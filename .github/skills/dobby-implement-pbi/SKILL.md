...
compatibility: GitHub CLI (gh), authenticated; OpenSpec CLI; git 2.5+ (worktree support)
metadata:
  author: dobby
  version: "1.0"
  scenario: github
...
<!-- Generated by scripts/build-skills.py from skills/github/dobby-implement-pbi/SKILL.md — do not edit this copy; edit the source and regenerate. -->
