...
compatibility: Azure CLI (az) with the azure-devops extension, authenticated; GitHub CLI (gh), authenticated
metadata:
  version: "1.0"
  author: dobby
  scenario: github
...
<!-- Generated by scripts/build-skills.py from skills/_common/grill-pbi/SKILL.md — do not edit this copy; edit the source and regenerate. -->
