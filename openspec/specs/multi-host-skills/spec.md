# multi-host-skills Specification

## Purpose

Define how skill definitions in this repository are authored once and discovered by multiple AI coding hosts (GitHub Copilot CLI and Claude Code) without diverging. Establishes a single canonical source under `skills/`, mirrored copies under `.github/skills/` and `.claude/skills/`, and the tooling and documentation that keep the three trees consistent.
