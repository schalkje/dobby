...
description: Create a PBI/issue in this project's tracker. Auto-detects Azure DevOps vs GitHub from .dobby/config.json and hands off to the matching backend skill. Use this for any "create a pbi", "create an issue", "make a work item", or "open a ticket" request.
metadata:
  author: dobby
  version: "2.0"
---
