...
<!-- Generated by scripts/build-skills.py from skills/ado/dobby-close-pbi/SKILL.md — do not edit this copy; edit the source and regenerate. -->
...
```bash
python dobby-close-pbi/scripts/azdo-delete-comment.py \
