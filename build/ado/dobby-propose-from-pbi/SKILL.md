...
<!-- Generated by scripts/build-skills.py from skills/ado/dobby-propose-from-pbi/SKILL.md — do not edit this copy; edit the source and regenerate. -->
...
- **Use canonical `skills/` paths.** Reference scripts and templates from the canonical `skills/` directory — e.g., `python dobby-create-pbi/scripts/azdo-update-fields.py`, not from `.github/skills/` or `.claude/skills/` host copies.
...
Use the helper script at `dobby-create-pbi/scripts/azdo-update-fields.py` to update fields as Markdown:
